    ...
    <div class="container-fluid bg-dark text-white">
        <div class="row align-items-center">
            ...
            <div class="col-md-5 text-center">
                <h1><a href="${pageContext.request.contextPath}/admin/news" class="text-decoration-none text-white">CÔNG
                    CỤ QUẢN TRỊ TIN TỨC</a></h1>
            </div>
            ...
            <nav class="nav justify-content-center mb-4">
                <a class="nav-link" href="${pageContext.request.contextPath}/admin/news">Tin tức</a> <span
                    class="nav-link">:</span> <a class="nav-link"
                                                 href="${pageContext.request.contextPath}/admin/category">Loại tin</a>
                <span
                        class="nav-link">:</span> <a class="nav-link"
