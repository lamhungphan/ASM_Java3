...
<body>
		...
		<div class="container-fluid bg-dark text-white">
			<div class="row align-items-center">
				...
				<div class="col-md-5 text-center">
					<h1><a href="${pageContext.request.contextPath}/admin/article" class="text-decoration-none text-white">CÔNG CỤ QUẢN TRỊ TIN TỨC</a></h1>
				</div>
				<div class="col-md-6 text-end">
					...
					<div class="dropdown d-inline-block mx-1">
						...
						<ul class="dropdown-menu dropdown-menu-end"
							...
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/user/home">Trang
									đọc giả</a></li>
							<li><a class="dropdown-item"
								href="${pageContext.request.contextPath}/admin/user/edit/${sessionScope.currUser.id}">Trang cá nhân</a></li>
							<li><a class="dropdown-item"
								href="${pageContext.request.contextPath}/user/changePass">Đổi mật khẩu</a></li>
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/user/logout">Đăng
									xuất</a></li>
						</ul>
					</div>
				</div>
	...
	<c:if test="${sessionScope.currUser==null}">
		...
		<a href="${pageContext.request.contextPath}/user/login">Nhấn vào đây để đăng nhập</a>
	</c:if>
</body>
</html>