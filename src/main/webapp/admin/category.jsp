...
<div>
            ...
            <c:forEach var="cate" items="${list}">
                <tr>
                    ...
                    <td><input type="text" name="update${cate.id}"
                               value="${cate.name}"></td>
                    <td>
                        <button formaction="${pageContext.request.contextPath}/admin/category/update/${cate.id}">Sửa
                        </button>
                    </td>
                    <td>
                        <button formaction="${pageContext.request.contextPath}/admin/category/delete/${cate.id}">Xóa
                        </button>
                    </td>
                </tr>
            </c:forEach>
    ...
    <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/category/new">Thêm thể loại</a>
