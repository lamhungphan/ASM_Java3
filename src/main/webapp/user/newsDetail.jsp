<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="container my-4">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <a href="${pageContext.request.contextPath}/user/detail/relatedNews.id" class="btn btn-primary">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
        ...
        <div class="mt-4 text-center">
            <a href="${pageContext.request.contextPath}/user/views/home.jsp" class="btn btn-primary position-fixed bottom-0 end-0 m-4">
